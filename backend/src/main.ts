...
async function bootstrap() {
  ...
  // Includes: CSP, XSS Protection, HSTS, X-Frame-Options, and more
  ...
  // Enable enhanced ValidationPipe globally
  // Features: whitelist, forbidNonWhitelisted, transform with nested object support
  ...
  const swaggerOptions = new DocumentBuilder()
    ...
    .addServer('https://api.linxio.com', 'Production server')
    .build();
