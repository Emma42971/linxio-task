...
import { ProjectsPaginationInput, ProjectsPaginationOutput } from './dto/pagination.dto';
...
export class ProjectsService {
  ...
  /**
   * Find projects with cursor-based pagination
   */
  async findWithCursorPagination(
    pagination: ProjectsPaginationInput,
    workspaceId?: string,
    organizationId?: string,
    search?: string,
    userId?: string,
  ): Promise<ProjectsPaginationOutput> {
    if (!userId) {
      throw new ForbiddenException('User context required');
    }
    ...
    return new ProjectsPaginationOutput(data, paginationMeta);
  }
