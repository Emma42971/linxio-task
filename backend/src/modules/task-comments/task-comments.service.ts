...
import { TaskCommentsPaginationInput, TaskCommentsPaginationOutput } from './dto/pagination.dto';
...
export class TaskCommentsService {
  ...
  /**
   * Find all comments with cursor-based pagination
   */
  async findAllWithCursor(
    pagination: TaskCommentsPaginationInput,
    taskId?: string,
    sort: 'asc' | 'desc' = 'desc',
  ): Promise<TaskCommentsPaginationOutput> {
    ...
    if (cursor) {
      whereClause.id = sort === 'desc' ? { lt: cursor } : { gt: cursor };
    }
    ...
    return new TaskCommentsPaginationOutput(data, paginationMeta);
  }
