...
import { TasksPaginationInput, TasksPaginationOutput } from './dto/pagination.dto';
...
export class TasksService {
  ...
  /**
   * Find all tasks with cursor-based pagination
   */
  async findAllWithCursor(
    organizationId: string,
    pagination: TasksPaginationInput,
    projectId?: string[],
    sprintId?: string,
    workspaceId?: string[],
    parentTaskId?: string,
    ...
    return new TasksPaginationOutput(transformedTasks, paginationMeta);
  }
