 ...
 *
 * Options:
 *   --source   Source SVG file path (default: assets/logo/linxio-task-logo.svg)
...
const DEFAULT_SOURCE = path.join(ROOT_DIR, 'assets/logo/linxio-task-logo.svg');
...
const ICON_SIZES = [
  ...
  { name: 'linxio-task-logo.png', size: 512, description: 'Linxio Task Logo' },
];
